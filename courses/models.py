...
class Review(models.Model):
    ...
    taken_season = models.CharField(max_length=200, choices=(season_choices), blank=False, default="Fall")
    taken_year = models.IntegerField(choices=(year_choices), blank=False, default="2019")
